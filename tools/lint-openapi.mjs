...
assert.ok(filePath, "usage: node tools/lint-openapi.mjs <openapi-file>");
...
for (const requiredPath of requiredPaths) {
  assert.ok(document.paths[requiredPath], `missing required path: ${requiredPath}`);
}

console.log(`openapi lint ok (${operations.length} operations)`);
