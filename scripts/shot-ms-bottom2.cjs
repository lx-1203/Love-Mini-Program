...
// 先 reLaunch 到首页稳定，再切 match-success
try{ await mp.reLaunch('/pages/home/index'); await sleep(8000); }catch(e){}
try{
  await mp.reLaunch('/pages/discover/match-success?userId=2');await sleep(25000);
  await mp.pageScrollTo(99999);await sleep(12000);
