...
await mp.screenshot({path:'D:/6/恋爱小程序/tmp/msg-rel2.png',fullPage:false});await sleep(2000);
console.log('size:',fs.existsSync('D:/6/恋爱小程序/tmp/msg-rel2.png')?fs.statSync('D:/6/恋爱小程序/tmp/msg-rel2.png').size:0);
