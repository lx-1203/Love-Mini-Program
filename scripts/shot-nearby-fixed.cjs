...
async function main(){
  ...
  try{ await mp.reLaunch('/pages/nearby/index'); await new Promise(r=>setTimeout(r,14000)); const out='D:\\6\\恋爱小程序\\tmp\\nearby-fixed.png'; await mp.screenshot({path:out}); console.log('[OK]',out); }catch(e){ console.log('[FAIL]',e.message); }
