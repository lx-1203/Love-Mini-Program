# shot-round2.ps1 - 2026-08-27 full page screenshots (top+bottom), automator channel
# Usage: powershell -ExecutionPolicy Bypass -File scripts\shot-round2.ps1 [-Pages n]
...
$PAGE_LIST = @(
  @{ n = "01-login";        u = "/pages/login/index";                       w = 5 },
  @{ n = "02-home";         u = "/pages/home/index";                        w = 6 },
  @{ n = "03-discover";     u = "/pages/discover/index";                    w = 6 },
  @{ n = "04-nearby";       u = "/pages/nearby/index";                      w = 6 },
  @{ n = "05-matching";     u = "/pages/discover/matching?preview=1&cardId=1&action=like&userId=2"; w = 5 },
  @{ n = "06-match-success";u = "/pages/discover/match-success?userId=2";   w = 5 },
  ...
  @{ n = "11-post-create";  u = "/pages/village/post";                      w = 5 },
  @{ n = "12-post-detail";  u = "/pages/village/detail?id=1";               w = 6 },
  @{ n = "13-messages";     u = "/pages/messages/index";                    w = 6 },
  @{ n = "14-official-chat";u = "/pages/official-chat/index";               w = 5 },
  @{ n = "15-chat-session"; u = "/pages/chat-session/index?userId=2";       w = 5 },
  @{ n = "16-profile-own";  u = "/pages/profile/index";                     w = 6 },
  @{ n = "17-profile-other";u = "/pages/profile/other?userId=2";            w = 6 },
  @{ n = "18-activity";     u = "/pages/activities/detail?id=2001";         w = 6 },
  @{ n = "19-settings";     u = "/pages/settings/index";                    w = 5 },
  @{ n = "20-security";     u = "/pages/security/index";                    w = 5 },
  @{ n = "21-likes";        u = "/pages/likes/index";                       w = 5 },
  @{ n = "22-album";        u = "/pages/profile/album";                     w = 5 },
  @{ n = "23-circles-detail";u = "/pages/circles/topic-detail?id=1";        w = 5 },
  @{ n = "24-camp-post";    u = "/pages/campus/post-topic";                 w = 5 }
)
