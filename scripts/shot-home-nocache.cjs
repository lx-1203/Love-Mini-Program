...
await mp.screenshot({path:'D:/6/恋爱小程序/tmp/home-nocache.png',fullPage:false});await sleep(2000);
console.log('size:',fs.existsSync('D:/6/恋爱小程序/tmp/home-nocache.png')?fs.statSync('D:/6/恋爱小程序/tmp/home-nocache.png').size:0);
