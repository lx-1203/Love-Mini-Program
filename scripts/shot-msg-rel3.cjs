...
await mp.screenshot({path:`${REPO_ROOT}/tmp/msg-rel3.png`,fullPage:false});await sleep(2000);
console.log('size:',fs.existsSync(`${REPO_ROOT}/tmp/msg-rel3.png`)?fs.statSync(`${REPO_ROOT}/tmp/msg-rel3.png`).size:0);
