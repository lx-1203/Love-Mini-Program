...
await mp.reLaunch('/pages/nearby/index');await sleep(20000);
await mp.pageScrollTo(400);await sleep(4000);
await mp.screenshot({path:'D:/6/恋爱小程序/tmp/nearby-circles.png', fullPage:false});
console.log('nearby shot done');
