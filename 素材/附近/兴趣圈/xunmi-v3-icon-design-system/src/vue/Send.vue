...
<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none"
    ...
    <path d="M3.5 4.5 21 12 3.5 19.5l2.2-6.2L15 12 5.7 10.7 3.5 4.5Z" fill="none" :stroke="resolvedColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
