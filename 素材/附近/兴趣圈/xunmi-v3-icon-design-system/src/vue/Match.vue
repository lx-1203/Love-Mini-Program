...
<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none"
    ...
    <path d="M18.3 16.2v5.1" fill="none" :stroke="resolvedColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M15.75 18.75h5.1" fill="none" :stroke="resolvedColor" :stroke-width="strokeWidth" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
</template>
