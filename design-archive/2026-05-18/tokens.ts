...
export const designTokens = {
  ...
  color: {
    ...
    // 渐变预设
    gradient: {
      brand:    'linear-gradient(135deg, #F4707A 0%, #FF8DA2 100%)',
      secondary:'linear-gradient(135deg, #3ECBB1 0%, #6FDBC3 100%)',
      warmCool: 'linear-gradient(135deg, #F4707A 0%, #3ECBB1 100%)',
      sunset:   'linear-gradient(135deg, #FFB84D 0%, #F4707A 100%)',
    },
  },
  ...
  shadow: {
    ...
    // 品牌色阴影（用于按钮/卡片悬停）
    brand: '0 8px 24px rgba(244, 112, 122, 0.25)',
    secondary: '0 8px 24px rgba(62, 203, 177, 0.25)',
  },
