...
JOIN (
    ...
    SELECT 100000, 10009, '同款经历，握手', 4 UNION ALL
    SELECT 100000, 10010, '支持一下楼主', 6 UNION ALL
    SELECT 100000, 10011, '这个必须收藏', 9 UNION ALL
    SELECT 100000, 10012, '说得在理', 11 UNION ALL
