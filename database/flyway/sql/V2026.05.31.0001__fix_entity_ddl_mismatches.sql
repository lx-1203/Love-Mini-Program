...
ALTER TABLE daily_questions ADD COLUMN IF NOT EXISTS category VARCHAR(32) DEFAULT NULL AFTER question_text;

-- PrivateMessage 添加 quote_context 列（Entity 中已定义，DDL 缺失）
ALTER TABLE private_messages ADD COLUMN IF NOT EXISTS quote_context TEXT DEFAULT NULL AFTER message_kind;
