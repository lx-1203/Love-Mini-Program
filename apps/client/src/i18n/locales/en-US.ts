...
export default {
  ...
  config: {
    ...
    homeRecommendedPeople: {
      person1: {
        headline: "Peking University · Junior · Industrial Design",
        commonGround: "Common ground: movie nights and quiet café routes",
        availability: "Good time: after 7 PM tonight",
      },
      person2: {
        headline: "Tsinghua University · Master Y1 · Architecture",
        commonGround: "Pace match: prefers short meetups and clear time slots",
        availability: "Good time: Friday 4-6 PM",
      },
      person3: {
        headline: "Fudan University · Sophomore · Japanese",
        commonGround: "Shared preference: indoor fallback even when campus is crowded",
        availability: "Good time: weekend afternoons",
      },
      person4: {
        headline: "Zhejiang University · Senior · Journalism",
        commonGround: "You both picked the photography topic",
        availability: "Good time: every evening",
      },
      person5: {
        headline: "Renmin University of China · Freshman · Design",
        commonGround: "You both picked the travel topic",
        availability: "Good time: free afternoons",
      },
      person6: {
        headline: "Nanjing University · Junior · Law",
        commonGround: "You both picked the food topic",
        availability: "Good time: Tue & Thu evenings",
      },
      person7: {
        headline: "Wuhan University · Master Y2 · Medicine",
        commonGround: "You both picked the outdoor topic",
        availability: "Good time: all day on weekends",
      },
      person8: {
        headline: "Shanghai Jiao Tong University · Junior · Film Studies",
        commonGround: "You both picked the film topic",
        availability: "Good time: Saturday afternoons",
      },
      person9: {
        headline: "Sun Yat-sen University · Sophomore · Photography",
        commonGround: "You both picked the photography topic",
        availability: "Good time: Wed & Fri evenings",
      },
    },
  ...
  nearby: {
    title: "Nearby",
    goMatch: "Match",
    postsTitle: "Post picks",
    quickFind: "Find people · Find content",
    ...
    certGo: "Verify campus",
    certBenefit: "Campus badge · Trust · Recommendation weight",
    certDone: "Verified",
    segmentSameSchoolTitle: "Picks · Same school",
    groupSameInterest: "Picks · Same interest",
    groupOnline: "Picks · Online",
    groupHighMatch: "Picks · High match",
    segmentTitle: "Segment discover",
    segmentEmpty: "No more people in this group yet",
    tabsAria: "Nearby filters",
    tabPeople: "People",
    tabCircles: "Circles",
    tabCampus: "Campus",
    tabActivities: "Events",
    loading: "Loading nearby people…",
    loadFailed: "Failed to load nearby people",
    empty: "No new people nearby",
    circlesTitle: "Popular circles",
    campusTitle: "Nearby universities",
    activitiesTitle: "Nearby events",
    more: "More",
    circlePhoto: "Photography",
    circlePhotoDesc: "Capture light and life",
    circleMusic: "Music",
    circleMusicDesc: "Listen and chat about tunes",
    circleMovie: "Movies",
    circleMovieDesc: "A movie date on weekends",
    campusCircle: "Campus circle",
    campusCircleDesc: "Same-school topics and posts",
    activitiesEmpty: "No events nearby",
    circlesEmpty: "No posts yet — share your first one",
    publishToday: "Post",
    searchPlaceholder: "Search nearby",
    meetAuthor: "Meet them",
    homeSubtitle: "{school} · {dist}",
    defaultSchool: "Peking University",
    defaultDist: "3km",
    peopleTitle: "People Nearby",
    peopleNearby: "Nearby",
    peopleCity: "Same City",
    peopleNearbyDesc: "Find people close to you",
    peopleCityDesc: "More possibilities in your city",
    hotCircles: "Circles",
    ...
    viewAll: "All",
    peopleTabsAria: "Nearby / Same City toggle",
    meetSent: "Crush sent",
    meetMatched: "It's a match! Say hi",
  ...
  matchHub: {
    title: "Match Center",
    subtitle: "Be proactive and meet the one",
    findSomeone: "Find your crush",
    findDesc: "Meet the right person, start a beautiful story",
    startMatch: "Start matching",
    remaining: "{n} left today",
    remainingLabel: "Left today",
    usedToday: "Liked {n} today",
    usedLabel: "Liked today",
    onlineMatch: "Match online now",
    onlineDesc: "Now {n} people online",
    matchNow: "Match now",
    relationProgress: "Relationship progress",
    crushing: "Crushes",
    matched: "Matches",
    whispers: "Whispers",
    records: "Match history",
    normalMatch: "Standard match",
    normalMatchDesc: "Discover more people",
    onlineMatchDesc: "Real-time online, meet faster",
    flowTitle: "How matching works",
    flowStep1: "Pick a match mode",
    flowStep2: "Matching",
    flowStep3: "Meet someone you like",
    flowStep4: "It is a match!",
  ...
  matching: {
    ...
    likeFailed: "Failed, please retry",
    passFailed: "Skip failed, please retry",
    loadFailed: "No one found right now",
    degraded: "They went offline — continued as a normal match",
    offlineTag: "Offline",
    doneTitle: "This round is done",
    doneDesc: "Sent {n} crushes — waiting for replies",
    backToHub: "Back to Match",
  },
  matchSuccess: {
    title: "It's a match!",
    matchedWith: "You and {name} liked each other",
    matchedHint: "Time to say hello~",
    commonTags: "You both like: {tags}",
    reasonLabel: "You connected because",
    reasonEnd: "Start connecting",
    sayHi: "Chat now",
    explore: "Keep exploring",
    scoreTitle: "Here's what you have in common",
  },
  /* ========== v3 Whisper ========== */
  interestSelect: {
    title: "Pick your interests",
    subtitle: "Interests help us match you better (pick at least 3)",
    minThree: "Pick at least 3 interests",
    saved: "Saved",
  ...
  whisper: {
    ...
    toUser: "To {name}",
    defaultName: "them",
    placeholder: "Say something (max 60 chars)",
    price: "Price: 200 coins",
    balance: "Balance: {n} coins",
    send: "Send whisper",
    sent: "Delivered — shown first to them",
    sendFailed: "Failed, please retry",
    required: "Write something first",
    tooLong: "Max 60 characters",
  },
  tabs: {
    home: "Home",
    discover: "Discover",
    nearby: "Nearby",
    match: "Discover", // legacy: prefer tabs.discover
    chat: "Messages",
    profile: "Me",
    publish: "Post",
  },
  ...
  home: {
    ...
    todayPickMatch: "matches you",
    goMatch: "Match",
    entryCircles: "Circles",
    entryCampus: "Campus",
    entryActivities: "Events",
  ...
  activities: {
    ...
    quickFilterAria: "Activity quick filters",
    quickAll: "All",
    quickToday: "Today",
    quickWeekend: "Weekend",
    quickEmpty: "No activities in this filter — try another time",
  ...
  discover: {
    ...
    whisperGuideTitle: "They have a lot to tell you",
    whisperGuideDesc: "Unlock to read all their whispers",
    whisperListTitle: "What they want to say to you",
    whisperReplyPlaceholder: "Say something back…",
    whisperReplySend: "Reply",
    whisperReplyHint: "Your reply will be sent as a private message",
    whisperReplyEmpty: "Write something first",
    unlocking: "Unlocking…",
  ...
  chat: {
    ...
    newMatches: "New Matches",
      likedByGroup: "People who like you",
      likedByGoSee: "View",
    newMatchGoChat: "Say hi",
    whisperGroup: "Whispers",
    whisperRead: "Viewed",
    whisperUnreadText: "Delivered first — check it out",
    ...
    nav: {
      ...
      reportFailed: "Report failed, please retry",
    },
  ...
  profile: {
    ...
    tabAbout: "About",
    tabPosts: "Posts",
    tabsAria: "Profile section switcher",
    // Showcase entry
    ...
    savedTitle: "Saved",
    savedSubtitle: "People you saved, take your time",
    savedEmpty: "No saved people yet — explore Nearby",
    savedLoadFailed: "Failed to load saved people",
    savedUnfollow: "Unsave",
    savedUnfollowed: "Removed from saved",
    savedUnfollowFailed: "Failed to unsave, please retry",
    savedNoBio: "No bio yet",
    savedEntry: "Saved",
    statMatch: "Matches",
    statILike: "I like",
    statLiked: "Liked",
    menuProfile: "My profile",
    menuInterest: "Interests",
    menuInterestHint: "Pick at least 3",
    menuPosts: "My posts",
    menuPostsHint: "Recent posts",
    menuCheckin: "Daily check-in",
    menuPrivacy: "Privacy & security",
    menuPrivacyHint: "Account & privacy settings",
    checkinToday: "Check in for perks",
    checkinDone: "{n} days in a row",
    checkinSuccess: "Checked in",
    checkinFailed: "Check-in failed, please retry",
    heartValueTitle: "Heart Value",
    heartValueSubtitle: "The more you are liked, the higher it grows",
    heartValueMatch: "Matches",
    heartValueLike: "Crushes",
    heartValueVisitor: "Visitors",
    otherCommonTitle: "What you have in common",
    otherLike: "Like them",
    otherCrushSent: "Crush sent",
    otherMessage: "Say hi",
    otherFollow: "Follow",
    otherFollowed: "Followed",
    otherFollowFailed: "Failed to follow, please retry",
    ...
    albumTitle: "My Album",
    favoritesTitle: "My Favorites ({n})",
    favoritesCount: "{n} favorites",
    favoritesEmpty: "No favorites yet",
    favoritesEmptyDesc: "Tap the bookmark on a post to save it here",
    unfavorite: "Unfavorite",
    unfavoriteDone: "Removed from favorites",
    ...
    privacySavedLocal: "Saved on this device",
  ...
  village: {
    ...
    post: {
      ...
      locationHint: "Location picker coming soon",
      mentionHint: "Mention coming soon",
      draftModalTitle: "Keep draft?",
      draftModalContent: "You still have unpublished content. Keep it to edit later?",
      draftKeep: "Keep",
  ...
  login: {
    ...
    phoneQuickLogin: "Phone Login",
    phoneBoundSuccess: "Phone number bound successfully",
    phoneAuthFailed: "Phone authorization failed, please retry",
    useSmsInDevMode: "Use SMS code login in dev mode",
    useSmsToLogin: "Not signed in yet — please use SMS code or password login",
  ...
  showcase: {
    ...
    socialAssetsSection: "Social Assets", },
  ...
  likesVisitors: {
    ...
    unlockFailBalanceTitle: "Not enough coins",
    unlockFailBalanceContent: "Unlocking costs friendship coins. Go to the wallet to top up?",
    goRecharge: "Top up",
  ...
  messages: {
    title: "Messages",
    todayHeartSubtitle: "Something new is happening today",
  ...
  search: {
    ...
    campusNoUsers: "No recommended users at this school yet",
  ...
  setup: {
    profile: {
      ...
      submitSaveEdit: "Save",
      bottomNote: "Used for campus verification and matching only; takes effect immediately",
      backAria: "Back",
      ...
      errBioRequired: "Please enter your bio",
      errGradeRequired: "Please select your grade",
      errPronounsRequired: "Please enter your pronouns",
      errHeightRequired: "Please select your height",
      ...
      sectionMedia: "Avatar & Photos",
      mediaHint: "Real photos greatly improve match rate; uploads go through platform review",
      avatarLabel: "Avatar",
      avatarActionSheet: "Change avatar",
      avatarAlbum: "Choose from album",
      avatarCamera: "Take a photo",
      avatarUpdated: "Avatar updated",
      photoWallLabel: "Photo wall",
      photoWallHint: "Up to 6 photos, tap an empty slot to add",
      deletePhotoConfirm: "Delete this photo?",
      photoDeleted: "Deleted",
      uploadingMedia: "Uploading...",
      choosePhotoFailed: "Failed to choose image",
      noPhotoSelected: "No image selected",
      privacyRequiredImage: "Please agree to the privacy notice before uploading",
  ...
  campus: {
    ...
    publicBrowseTitle: "Public Browse",
    publicBrowseDesc: "You can browse public content. Verify this school to join private interactions",
      loadingAria: "Loading",
  ...
  circle: {
    ...
    detailMembersEmpty: "No active members yet",
    detailActivitiesEmpty: "No activities linked to this circle yet",
    meetAuthor: "Meet them",
    ...
    postTopicEnterFromCircle: "Please enter from a specific circle to post",
  ...
  dailyQuestion: {
    ...
    unlockSuccess: "Check-in successful, daily question unlocked",
    loadingAria: "Loading",
  ...
  settings: {
    ...
    /* Social assets group (2026-08-14: profile entries moved to settings) */
    socialAssetsSection: "Social Assets",
  ...
  mockData: {
    ...
    recommendedPeople: {
      ...
      headline8: "Shanghai Jiao Tong University · Junior · Film Studies",
      headline9: "Sun Yat-sen University · Sophomore · Photography",
      ...
      campusName8: "Shanghai Jiao Tong University",
      campusName9: "Sun Yat-sen University",
      ...
      commonGround8: "You both picked the film topic",
      commonGround9: "You both picked the photography topic",
      ...
      availability8: "Saturday afternoons",
      availability9: "Wed & Fri evenings",
      ...
      hometownCity7: "Wuhan",
      futureCity7: "Wuhan",
      hometownProvince8: "Shanghai",
      hometownCity8: "Shanghai",
      futureCity8: "Shanghai",
      hometownProvince9: "Guangdong",
      hometownCity9: "Guangzhou",
      futureCity9: "Guangzhou",
      ...
      bio8: "Film studies major who loves classic movies and indie directors. Happy to go to exhibitions, watch films, and stroll around together.",
      bio9: "Photography lover who always carries a camera to capture campus moments. Looking for someone to shoot streets and exhibitions with.",
    },
