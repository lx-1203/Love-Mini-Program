...
.profile-tabs {
  ...
  border: 1rpx solid var(--c-divider-light, #EEF2F0);
...
.profile-tabs__item--active {
  background: linear-gradient(135deg, var(--c-romance-400, #FF7C91) 0%, var(--c-romance-500, #FF6B81) 100%);
  box-shadow: var(--s-romance-md, 0 4rpx 16rpx rgba(255, 107, 129, 0.3));
}
