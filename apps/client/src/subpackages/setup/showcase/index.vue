...
const groups: ShowcaseGroup[] = [
  {
    ...
    items: [
      ...
      { path: "/subpackages/campus/campus/certification", titleKey: "showcase.groups.journey.items.campusCert.title", descKey: "showcase.groups.journey.items.campusCert.desc", chipBg: "var(--c-tint-blue-soft, #E8F4FF)" },
      { path: "/subpackages/profile-extra/verification/index", titleKey: "showcase.groups.journey.items.verification.title", descKey: "showcase.groups.journey.items.verification.desc", chipBg: "var(--c-tint-blue-soft, #E8F4FF)" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/subpackages/discover-extra/discover/history", titleKey: "showcase.groups.match.items.history.title", descKey: "showcase.groups.match.items.history.desc", chipBg: "var(--c-tint-orange-50, #FFF4EC)" },
      { path: "/subpackages/discover-extra/likes/index", titleKey: "showcase.groups.match.items.likes.title", descKey: "showcase.groups.match.items.likes.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/tools/heart-signals/index", titleKey: "showcase.groups.match.items.heartSignals.title", descKey: "showcase.groups.match.items.heartSignals.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/tools/love-center/nearby", titleKey: "showcase.groups.match.items.nearby.title", descKey: "showcase.groups.match.items.nearby.desc", chipBg: "var(--c-tint-orange-50, #FFF4EC)" },
    ],
  },
  {
    id: "home",
    ...
    items: [
      ...
      { path: "/subpackages/tools/daily-question/index", titleKey: "showcase.groups.home.items.dailyQuestion.title", descKey: "showcase.groups.home.items.dailyQuestion.desc", chipBg: "var(--c-bg-brand, #E8FAF3)" },
      { path: "/subpackages/tools/love-center/index", titleKey: "showcase.groups.home.items.loveCenter.title", descKey: "showcase.groups.home.items.loveCenter.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/tools/love-center/consulting", titleKey: "showcase.groups.home.items.consulting.title", descKey: "showcase.groups.home.items.consulting.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/tools/love-center/mbti", titleKey: "showcase.groups.home.items.mbti.title", descKey: "showcase.groups.home.items.mbti.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      ...
      { path: "/subpackages/tools/activities/detail", titleKey: "showcase.groups.home.items.activityDetail.title", descKey: "showcase.groups.home.items.activityDetail.desc", chipBg: "var(--c-tint-cream-50, #FFF8E7)" },
    ],
  },
  {
    id: "chat",
    ...
    items: [
      ...
      { path: "/subpackages/chat/chat-session/index", titleKey: "showcase.groups.chat.items.session.title", descKey: "showcase.groups.chat.items.session.desc", chipBg: "var(--c-tint-purple-soft, #F3EFFF)" },
    ],
  },
  {
    id: "community",
    ...
    items: [
      ...
      { path: "/subpackages/circles/circles/index", titleKey: "showcase.groups.community.items.circles.title", descKey: "showcase.groups.community.items.circles.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/circles/circles/topics", titleKey: "showcase.groups.community.items.topics.title", descKey: "showcase.groups.community.items.topics.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/circles/circles/topic-detail", titleKey: "showcase.groups.community.items.topicDetail.title", descKey: "showcase.groups.community.items.topicDetail.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/circles/circles/post-topic", titleKey: "showcase.groups.community.items.postTopic.title", descKey: "showcase.groups.community.items.postTopic.desc", chipBg: "var(--c-tint-pink-soft, #FFF0F5)" },
      { path: "/subpackages/campus/campus/index", titleKey: "showcase.groups.community.items.campus.title", descKey: "showcase.groups.community.items.campus.desc", chipBg: "var(--c-tint-blue-soft, #E8F4FF)" },
      { path: "/subpackages/campus/campus/post-topic", titleKey: "showcase.groups.community.items.campusPostTopic.title", descKey: "showcase.groups.community.items.campusPostTopic.desc", chipBg: "var(--c-tint-blue-soft, #E8F4FF)" },
      { path: "/subpackages/campus/campus/topic-detail", titleKey: "showcase.groups.community.items.campusTopicDetail.title", descKey: "showcase.groups.community.items.campusTopicDetail.desc", chipBg: "var(--c-tint-blue-soft, #E8F4FF)" },
      ...
      { path: "/subpackages/profile-extra/feedback/history", titleKey: "showcase.groups.community.items.feedbackHistory.title", descKey: "showcase.groups.community.items.feedbackHistory.desc", chipBg: "var(--c-tint-cream-50, #FFF8E7)" },
    ],
  },
  {
    id: "commerce",
    ...
    items: [
      { path: "/subpackages/vip/index", titleKey: "showcase.groups.commerce.items.vip.title", descKey: "showcase.groups.commerce.items.vip.desc", chipBg: "var(--c-vip-bg-soft, #FEF3C7)" },
      { path: "/subpackages/market/wallet/index", titleKey: "showcase.groups.commerce.items.wallet.title", descKey: "showcase.groups.commerce.items.wallet.desc", chipBg: "var(--c-tint-cream-50, #FFF8E7)" },
      { path: "/subpackages/vip/promo-code", titleKey: "showcase.groups.commerce.items.promoCode.title", descKey: "showcase.groups.commerce.items.promoCode.desc", chipBg: "var(--c-vip-bg-soft, #FEF3C7)" },
      { path: "/subpackages/vip/bills", titleKey: "showcase.groups.commerce.items.bills.title", descKey: "showcase.groups.commerce.items.bills.desc", chipBg: "var(--c-vip-bg-soft, #FEF3C7)" },
      { path: "/subpackages/market/shop/index", titleKey: "showcase.groups.commerce.items.shop.title", descKey: "showcase.groups.commerce.items.shop.desc", chipBg: "var(--c-tint-cream-50, #FFF8E7)" },
    ],
  },
  {
    id: "profile",
    ...
    accent: "linear-gradient(135deg, #64748B, #999999)",
    items: [
      ...
      { path: "/subpackages/profile-extra/profile/visitors", titleKey: "showcase.groups.profile.items.visitors.title", descKey: "showcase.groups.profile.items.visitors.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
      { path: "/subpackages/profile-extra/profile/album", titleKey: "showcase.groups.profile.items.album.title", descKey: "showcase.groups.profile.items.album.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
      { path: "/subpackages/profile-extra/profile/tasks", titleKey: "showcase.groups.profile.items.tasks.title", descKey: "showcase.groups.profile.items.tasks.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
      { path: "/subpackages/profile-extra/profile/privacy", titleKey: "showcase.groups.profile.items.privacy.title", descKey: "showcase.groups.profile.items.privacy.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
      { path: "/subpackages/profile-extra/settings/index", titleKey: "showcase.groups.profile.items.settings.title", descKey: "showcase.groups.profile.items.settings.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
      { path: "/subpackages/profile-extra/settings/dnd", titleKey: "showcase.groups.profile.items.dnd.title", descKey: "showcase.groups.profile.items.dnd.desc", chipBg: "var(--c-neutral-100, #F1F5F9)" },
