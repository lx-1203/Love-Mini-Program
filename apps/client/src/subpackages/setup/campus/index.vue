...
<template>
  <AppShell title="学校信息" subtitle="先手动填写，认证状态以后端回传为准。" :show-tab-bar="false">
    ...
    <SectionCard title="学校资料" compact>
      <input v-model="form.city" class="field" placeholder="城市" aria-label="城市" />
      <input v-model="form.campusName" class="field" placeholder="学校名称" aria-label="学校名称" />
      <input v-model="form.department" class="field" placeholder="院系" aria-label="院系" />
    </SectionCard>
