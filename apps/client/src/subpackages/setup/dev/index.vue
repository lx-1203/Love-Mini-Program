...
/** 会员身份模拟开关（dev 页切换，vip store 读取；2026-08-10 统一至 STORAGE_KEYS） */
const devVipSim = ref(false);
const VIP_SIM_KEY = STORAGE_KEYS.VIP_SIM_ENABLED;
...
const pages: PageItem[] = [
  ...
  { path: "/subpackages/circles/circles/index", title: "兴趣圈", group: "主包" },
  { path: "/subpackages/circles/circles/topics", title: "话题列表", group: "主包" },
  { path: "/subpackages/circles/circles/topic-detail", title: "话题详情", group: "主包" },
  { path: "/subpackages/circles/circles/post-topic", title: "发布话题", group: "主包" },
  { path: "/subpackages/tools/daily-question/index", title: "每日一问", group: "主包" },
  { path: "/subpackages/chat/chat-session/index", title: "会话", group: "主包" },
  // 子包页面
