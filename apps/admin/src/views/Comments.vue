 ...
 *
 * 交互参考 Users.vue：分页列表（Pagination）+ 删除前 ConfirmDialog 二次确认。
 */
...
const deleteTarget = ref<AdminCommentSummary | null>(null);
...
/** 点击删除：打开确认弹窗 */
function handleDeleteClick(comment: AdminCommentSummary) {
...
/** 作者展示：昵称缺失时回退到 用户#{id} */
function authorLabel(comment: AdminCommentSummary): string {
